...
# Mapping from trash classes to bin types
BIN_MAPPING = {
    'plastic_bottle': 'Recyclable bin',
    'aluminium_can': 'Recyclable bin',
    'paper': 'Recyclable bin',
    'glass_bottle': 'Recyclable bin',
    'food_waste': 'Food waste bin',
    'banana_peel': 'Food waste bin',
    'apple_core': 'Food waste bin',
    'other_trash': 'Other waste bin',
